...
const SingleBook = (props) => {
  ...
  let { writer, name, description, image, tagList, id } = book;
  return (
    <section className="px-40">
      <div className="bg-secondary py-8 pl-40 shadow">
        ...
        <p className="py-5 text-lg text-gray-600">{description}</p>
        <p className="py-5 text-lg text-gray-600">{writer}</p>
        <p className="py-4 text-gray-600">{tagList}</p>
      </div>
